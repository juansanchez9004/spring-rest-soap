package com.co.parameta.soap.config;
...
@EnableWs
@Configuration
public class ConfigWS extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema empleadoSchema) {
        ...
        definition.setTargetNamespace("http://parameta.co.com/soap/ws/empleado");
        return definition;
    }
