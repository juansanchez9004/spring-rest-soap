 ...
 *       &lt;sequence&gt;
 *         &lt;element name="data" type="{http://parameta.co.com/soap/ws/empleado}empleadoResponse"/&gt;
...
public class CreateEmpleadoResponse {
    ...
    protected EmpleadoResponse data;
    @XmlElement(required = true)
     ...
     *     
     */
    public EmpleadoResponse getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(EmpleadoResponse value) {
        this.data = value;
    }
